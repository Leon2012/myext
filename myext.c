...
PHP_MINIT_FUNCTION(myext)
{
	...
	*/
	...
	//MY_MODULE_STARTUP(instance_class);

	ZEND_MODULE_STARTUP_N(my_request) (INIT_FUNC_ARGS_PASSTHRU);
	ZEND_MODULE_STARTUP_N(my_instance_class) (INIT_FUNC_ARGS_PASSTHRU);
